...
echo "  - gnss_navigation (gnss_spresense_node, gnss_ublox_node, gnss_mission_monitor_node)"
echo "  - rover_monitoring (rover_monitoring_node, mission_monitoring_node_rpi)"
echo "  - rover_bringup"
echo ""
