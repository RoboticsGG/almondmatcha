#!/usr/bin/env bash
# Remote flash helper for mros2-mbed-sensors-gnss
# Usage: ./scripts/remote_flash_sensors.sh
# Runs on the remote machine that has the board attached.

set -euo pipefail

BIN_PATH="/home/yupi/almondmatcha/mros2-mbed-sensors-gnss/build/mros2-mbed.bin"
