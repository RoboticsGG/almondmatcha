...
echo -e "  Window 0: mission_command_node"
  echo -e "  Window 1: mission_monitoring_node_pc"
echo -e "\n${Y}Controls:${N}"
...
echo -e "${B}Domains:${N} mission_command_node=D5 (control) | mission_monitoring_node_pc=D4 (monitoring)"
echo -e "${B}Communication:${N} D5 rover control + D4 telemetry relay (reduces STM32 participant count)\n"
