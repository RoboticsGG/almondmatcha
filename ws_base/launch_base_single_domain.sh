...
main() {
    ...
    tmux send-keys -t $SESSION_NAME:0 "cd $WS_PATH && source install/setup.bash && export ROS_DOMAIN_ID=5" C-m
    ...
    tmux send-keys -t $SESSION_NAME:1 "cd $WS_PATH && source install/setup.bash && export ROS_DOMAIN_ID=5" C-m
